namespace Escola.Domain.Utils
{
    public static class Constantes
    {
        public static class Aluno
        {
            ...
            public const string sqlInsert = "INSERT INTO tb_aluno ( id_cpf_aluno, nome_aluno, data_nascimento) VALUES('@id_cpf_aluno','@nome','2099-05-20')";

        }
        public static class Professor
        {
            public const string sqlBuscarPorCpf = "select id_cpf_aluno, nome_professor, data_nascimento from tb_professor";
